    ...
    return (
        ...
        <div className='intro'>
            <div className="welcome animate__animated animate__fadeIn">
                ...
                <div className="image1"><img src={Waiting} /></div>
            </div>
            <div className='why animate__animated animate__fadeInUp'>
                ...
                <div className='image1'><img src={Raze} /></div>
            </div>
            <div className='prize-info tag'>
                <section className='text' style={{ marginTop: '40px' }}>
                    ...
                    bạn có thể thông cảm cho sự bất tiện này.
</p>
                ...
                <div className='image1'><img src={Wingman} /></div>
            </div>
            <div className='social-media tag'>
                ...
                <div className='social-link tag'>
                    <div className='facebook'><a href='https://www.facebook.com/dongchuyennghiep' className='linkfb'><div className='pa'><FontAwesomeIcon icon={faFacebook} className='facebook' />
                        <p style={{ fontStyle: 'italic', fontWeight: '900', marginTop: '20px' }}>DONG CHUYEN NGHIEP</p>
                        </div></a></div>
                    <div className='instagram'>
                    <a href='https://www.instagram.com/dongchuyennghieppn/' className='linkinsta'><div className='pa'><FontAwesomeIcon icon={faInstagram} className='instagram' /><p style={{ fontWeight: '900', marginTop: '20px' }}>dongchuyennghiep</p></div></a></div>
                    <div className='discord'><a href='https://discord.gg/wkBH9DqJdT' className='linkdis'><div className='pa'><FontAwesomeIcon icon={faDiscord} className='discord' />
                        <p style={{ fontWeight: '900', marginTop: '20px' }}>
                            THPT Phú Nhuận</p></div></a></div>
                </div>
            </div>
        </div >
        )}
